...
from urbanroadsweeper.Experimenter import Experimenter
from urbanroadsweeper.HyperOptimizer import HyptoOptimizer
    ...
    def main(self):
        ...
        if USE_MANUAL_PARAMETERS:
            ...
            if algorithm_name == "sampled":
                ...
                opt_param = fmin(   lambda args: hyper_optimizer.hyper_opt_test(args, algorithm["parameters"]),
                ...
                opt_param = fmin(   lambda args: hyper_optimizer.hyper_opt_test(args, algorithm["parameters"]),
                        space= algorithm["hyper_test_space"],
                        algo=tpe.suggest,
                        max_evals=HYPER_MAX_EVAL,
                        trials=trials)
