...
from urbanroadsweeper.NewCPP import NewCPP

from urbanroadsweeper.PointCloud import PointCloud
#from urbanroadsweeper.HyperOptimizer import hyper_test_bastar, hyper_test_inward_spiral, hyper_test_sampled_bastar, hyper_test_new
...
ALGORITHMS = {
    "spiral": {
        ...
        "parameters": ["step_size", "visited_threshold"],
        "hyper_test_space": (   hp.uniform('step_size', 0.5, 1), 
    ...
    "bastar": {
        ...
        "hyper_time_limit": HYPER_TIME_LIMIT,
        "hyper_min_coverage": HYPER_MIN_COVERAGE,
        "parameters": ["angle_offset", "step_size", "visited_threshold"],
        "hyper_test_space": (   hp.uniform('angle_offset', 0, np.pi*2),
    ...
    "sampled": {
        ...
        "hyper_time_limit": HYPER_TIME_LIMIT,
        "hyper_min_coverage": HYPER_MIN_COVERAGE,
        "parameters": ["ba_exploration", "max_distance", "max_distance_part_II", "min_bastar_cost_per_coverage", "min_spiral_cost_per_coverage", "step_size", "visited_threshold"],
        "do_experiment": True,
        "experiment_time_limit": EXP_TIME_LIMIT,
        "experiment_results": [],
    ...
    #    "hyper_min_coverage": HYPER_MIN_COVERAGE,
    #    "parameters": ["param_1"],
    #    "hyper_test_space": (   hp.uniform('param_1', 0, 1)),
    #    "do_experiment": True,
    #    "experiment_time_limit": EXP_TIME_LIMIT,
    #    "experiment_results": [],
    #    "hyper_data": [],
    #    "formatted_hyper_data": [],
    #    "cpp": lambda print, motion_planner, cov_points, time_limit, parameters: NewCPP(print, motion_planner, PointCloud(print, points= cov_points), time_limit, parameters), 
    #}
}
